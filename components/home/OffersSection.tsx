...
const TONES = [
  {
    tone: "bg-linear-to-br from-rose-50 via-pink-50 to-fuchsia-50 dark:from-rose-950/40 dark:via-pink-950/30 dark:to-fuchsia-950/20",
    iconBg: "bg-linear-to-br from-rose-500 to-pink-600 shadow-rose-500/30",
    border:
    ...
    codeBg:
      "bg-linear-to-r from-rose-50 to-pink-50 border-rose-200 dark:from-rose-500/10 dark:to-pink-500/10 dark:border-rose-500/30",
    codeColor: "text-rose-600 dark:text-rose-400",
    icon: <Zap className="h-5 w-5" />,
  },
  {
    tone: "bg-linear-to-br from-amber-50 via-yellow-50 to-orange-50 dark:from-amber-950/40 dark:via-yellow-950/30 dark:to-orange-950/20",
    iconBg:
    ...
    codeBg:
      "bg-linear-to-r from-amber-50 to-orange-50 border-amber-200 dark:from-amber-500/10 dark:to-orange-500/10 dark:border-amber-500/30",
    codeColor: "text-amber-700 dark:text-amber-400",
    icon: <Tag className="h-5 w-5" />,
  },
  {
    tone: "bg-linear-to-br from-sky-50 via-blue-50 to-indigo-50 dark:from-sky-950/40 dark:via-blue-950/30 dark:to-indigo-950/20",
    iconBg: "bg-linear-to-br from-sky-500 to-blue-600 shadow-sky-500/30",
    border:
    ...
    codeBg:
      "bg-linear-to-r from-sky-50 to-blue-50 border-sky-200 dark:from-sky-500/10 dark:to-blue-500/10 dark:border-sky-500/30",
    codeColor: "text-sky-700 dark:text-sky-400",
    icon: <BadgePercent className="h-5 w-5" />,
  },
  {
    tone: "bg-linear-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-emerald-950/40 dark:via-green-950/30 dark:to-teal-950/20",
    iconBg:
    ...
    codeBg:
      "bg-linear-to-r from-emerald-50 to-teal-50 border-emerald-200 dark:from-emerald-500/10 dark:to-teal-500/10 dark:border-emerald-500/30",
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -inset-px opacity-0 transition-opacity duration-500 group-hover:opacity-100">
        <div
          className={`absolute inset-0 bg-linear-to-r ${offer.accent} opacity-[0.03] dark:opacity-[0.06]`}
        />
      </div>
      ...
      <div className="relative">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-white/90 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-slate-500 shadow-sm backdrop-blur-sm dark:bg-white/10 dark:text-slate-400">
            <span
              className={`inline-block h-1.5 w-1.5 rounded-full bg-linear-to-r ${offer.accent} animate-pulse`}
            />
            {t("limitedOffer")}
          </span>
        </div>
        ...
        {/* Separator */}
        <div
          className={`my-4 h-px bg-linear-to-r from-transparent ${offer.accent} to-transparent opacity-20`}
        />
    ...
    <section className="relative overflow-hidden bg-linear-to-b from-slate-50 via-white to-slate-50 dark:from-[#0b1020] dark:via-[#0d1328] dark:to-[#0b1020]">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="flex items-end justify-between">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-rose-200/80 bg-linear-to-r from-rose-50 to-pink-50 px-4 py-1.5 shadow-sm dark:border-rose-500/20 dark:from-rose-500/10 dark:to-pink-500/10">
